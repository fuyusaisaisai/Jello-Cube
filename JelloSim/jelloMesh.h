...
protected:
	...
	virtual bool JelloMesh::SphereIntersection(Particle& p, World::Sphere* sphere, JelloMesh::Intersection& result);
	virtual bool JelloMesh::CubeIntersection(Particle& p, World::Cube* cube, JelloMesh::Intersection& result);
...
public:
	friend void rayHit(vec3 m_start,vec3 m_end);
